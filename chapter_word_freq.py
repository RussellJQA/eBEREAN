...
def main():
    ...
    with open(read_fn, "r") as read_file:
        ...
        for (key, word_frequencies) in word_frequency_lists_chapters.items():
            ...
            for (chapter_frequency, words) in word_frequencies.items():
                if words != ["TOTAL WORDS"]:
                    ...
                    for word in words:
                        ...
                        values = [int(chapter_frequency), word_freq, relative_frequency]
            ...
            # print(f"\n{key}: {words_in_chapter} total words")
            # for word, values in relative_word_frequency.items():
            #     print_word_info(word, values)
